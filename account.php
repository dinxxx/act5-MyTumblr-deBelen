...
body {
    background: c;
    background: linear-gradient(to right, #D7BDE2, #17202A);
    min-height: 100vh;
    overflow-x: hidden
}</style>
                                </head>
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <h5 class="font-weight-bolder mb-0 d-block">1,434</h5><small class="text-muted"> <i class="fas fa-image mr-1"></i>Photos</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">2,022</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Followers</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">2,222</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Following</small>
                    </li>
                </ul>
            </div>
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">Video Editting</p>
            ...
            <div class="py-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-lg-1"><img src="images/pic3.jpg" alt="" class="img-fluid rounded shadow-sm"></div>
                </div> 
            </div>
